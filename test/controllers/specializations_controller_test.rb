...
class SpecializationsControllerTest < ActionController::TestCase
  ...
  test "should create specialization" do
    assert_difference('Specialization.count') do
      post :create, specialization: { category_id: @specialization.category_id, description: @specialization.description, name: @specialization.name }
    end
  ...
  test "should update specialization" do
    patch :update, id: @specialization, specialization: { category_id: @specialization.category_id, description: @specialization.description, name: @specialization.name }
    assert_redirected_to specialization_path(assigns(:specialization))
  end
